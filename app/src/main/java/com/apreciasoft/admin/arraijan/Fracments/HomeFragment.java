package com.apreciasoft.admin.arraijan.Fracments;
...
import com.apreciasoft.admin.arraijan.Activity.HomeActivity;
...
import com.apreciasoft.admin.arraijan.Util.DataParser;
...
public class HomeFragment extends Fragment implements
    ...
    public static com.apreciasoft.admin.asremis.Util.SqliteUtil AsRemisSqlite;
...
/*
   ...
   /* public static class RelaxedHostNameVerifier implements HostnameVerifier {
    ...
    public void safeDistance(int idTravel,double distance) {
        ...
        AsRemisSqlite = new com.apreciasoft.admin.asremis.Util.SqliteUtil(view.getContext());
        ...
        SQLiteDatabase sqlite = AsRemisSqlite.getWritableDatabase();
                ...
                if(distance > 0) {
                    ...
                    content.put(com.apreciasoft.admin.asremis.Entity.TravelSqliteEntity.COLUMN_ID, idTravel);
                    content.put(com.apreciasoft.admin.asremis.Entity.TravelSqliteEntity.COLUMN_DISTANCE, distance);
                    content.put(com.apreciasoft.admin.asremis.Entity.TravelSqliteEntity.IS_DRETURN, HomeActivity.currentTravel.isRoundTrip);
                    sqlite.insert(com.apreciasoft.admin.asremis.Entity.TravelSqliteEntity.TABLE_NAME, null, content);
                }
    ...
    public static void removeTravel(int idTravel){
            ...
            //Se especifica en la cláusula WHERE el campo Producto y el producto introducido en el campo de texto a eliminar
             String WHERE = "WHERE " + com.apreciasoft.admin.asremis.Entity.TravelSqliteEntity.COLUMN_ID + " = '" + idTravel + "'";

            //Se borra el producto indicado en el campo de texto
            sqlite.delete(com.apreciasoft.admin.asremis.Entity.TravelSqliteEntity.TABLE_NAME, WHERE, null);
    ...
    public static Float  getDistanceSafe(int idTravel,int isReturn){
        ...
        if(isReturn == 1 || isReturn == 0){
            WHERE = com.apreciasoft.admin.asremis.Entity.TravelSqliteEntity.COLUMN_ID + " = '" + idTravel + "' AND "+ com.apreciasoft.admin.asremis.Entity.TravelSqliteEntity.IS_DRETURN+" = "+isReturn+" ";


        }else {
            WHERE = com.apreciasoft.admin.asremis.Entity.TravelSqliteEntity.COLUMN_ID + " = '" + idTravel + "'";

        }


        String[] columnas = {
                com.apreciasoft.admin.asremis.Entity.TravelSqliteEntity.COLUMN_DISTANCE
        };
        ...
        Cursor cursor = sqlite.query(com.apreciasoft.admin.asremis.Entity.TravelSqliteEntity.TABLE_NAME, columnas, WHERE, null, null, null,null);
    ...
    public static Float  getDistanceFilter_(int idTravel,int isReturn){
        ...
        String WHERE =  com.apreciasoft.admin.asremis.Entity.TravelSqliteEntity.COLUMN_ID + " = '" + idTravel + "' AND "+ com.apreciasoft.admin.asremis.Entity.TravelSqliteEntity.IS_DRETURN+" = "+isReturn+" LIMIT 1";
